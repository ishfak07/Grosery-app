...
const _tamil = <String, String>{
  ...
  'Subtotal': 'துணைத்தொகை',
  'Delivery charge': 'விநியோக கட்டணம்',
  ...
  'Track progress and review previous baskets':
      'முன்னேற்றத்தை கண்காணித்து முந்தைய கார்ட்களை பாருங்கள்',
  'Order {id}': 'ஆர்டர் {id}',
  ...
  'Need Clarification': 'தெளிவு தேவை',
  'Shopping Started': 'ஷாப்பிங் தொடங்கியது',
  'Item Unavailable': 'பொருள் கிடைக்கவில்லை',
  'Bill Updated': 'பில் புதுப்பிக்கப்பட்டது',
  'Out for Delivery': 'விநியோகத்திற்கு வெளியே',
